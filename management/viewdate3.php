  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>HEALTH ISSUES RECORD</h1>
          </div>
          <div class="col-sm-6">
            <form action="viewdate3.php">
              <div class="col-sm-6">
                <table>
                  ...
                  <tr>
                    ...
                    <td><input type="submit" value="view"></td><td><input type="submit" value="BACK" onclick="document.location='viewhealth.php'"> </td>
                  </tr>
                </table>
              </div>
            </form>            
    ...
    <table class="table table-stripped table-advance table-hover" border=2 > 
      ...
      <thead>   
        <th>Student Name</th>
        <th>Injury Type/Health Issue</th>
        <th>Date</th>
        <th>Amount</th>    
      </thead>
      <tbody>   
        ...
        $to=$_GET['to'];
        $table='injury';
        $stmt=$admin->ret("SELECT * FROM `injury` where `date` BETWEEN '$from' AND  '$to'");
        $subtotal=0;
        $total=0;
