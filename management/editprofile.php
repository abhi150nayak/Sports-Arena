  ...
  <div class="panel-body">
    <div class="profile-layout">  
      <div class="profile-section">
        ...
        <form method="post" action="controller/editprofilefile.php">
                ...
                <div class="info-section no-edit-forms">
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <input id="" type="text" class="form-control" name="phone" value="<?=$row['phone'] ?>">
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="input-group">
                      <span class="input-group-addon"><i class="fa fa-home fa-lg"></i></span>
                      <input id="" type="text" class="form-control" name="address" value="<?=$row['address'] ?>">
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="input-group">
                      <span class="input-group-addon"><i class="fa fa-address-book fa-lg"></i></span>
                      <input id="" type="text" class="form-control" name="place" value="<?=$row['place'] ?>">
                    </div>
                  </div>
