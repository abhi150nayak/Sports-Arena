      ...
      <hr>
        ...
        <tbody  id="result">
          ...
          <tr>
            ...
            <td><a href="updateprice.php?id=<?php echo $row['iid'];?>" onclick="return confirm('Are You Sure You Want To Update?')" class="btn btn-secondary">Update </a></td>
          </tr>
          <?php }?> 
        </tbody>
    </table>
...
xmlhttp.open("GET", "getResult3.php?q=" + alm, true);
xmlhttp.send();
}
</script>
</body>
