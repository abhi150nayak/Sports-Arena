...
<body>
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-9">
                <ul class="menu-items">
                    <li><a href="a.php">Events</a></li>
                   
                    <li class="active"><a href="c.php">Special</a></li> 
                </ul>
                <div style="width:100%;border-top:1px solid silver">
                    ...
                    <table class="table table-stripped table-advance table-hover" border=2>
                        ...
                        <tbody>
                            <?php 
                            $nstmt = $admin -> ret("SELECT * FROM `special` WHERE `play_id`='$result'");
                            while($nrow = $nstmt->fetch(PDO::FETCH_ASSOC)){?>      
                            <tr>
                                <td><?php echo $nrow['event'];?></td>
                                <td><?php echo $nrow['ev_date'];?></td>
                                <td><?php echo $nrow['achievement'];?></td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
