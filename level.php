            ...
            <div class="news-post-holder">
              ...
              <div class="dropdown">
                  ...
                  <div class="dropdown-content">
                    ...
                    <a href="level.php?id=Taluk Level">Taluk Level</a>
                    <a href="level.php?id=District Level">District Level</a>
                    <a href="level.php?id=State Level">State Level</a>
                    <a href="level.php?id=National Level">National Level</a>
                  </div>
                </div>
              <?php
              $id=$_GET['id'];
              $table='event';
              $stmt=$admin->ret("SELECT * FROM `event` WHERE `level`='$id'");
